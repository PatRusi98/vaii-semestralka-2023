            ...
            <form method="POST" action="{{ route('admin.drivers.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="name" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="John" pattern="[A-Za-z0-9\s]+" required>
                    </div>
                    <div>
                        <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900">Last name</label>
                        <input type="text" name="surname" id="last_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Rambo" pattern="[A-Za-z0-9\s]+" required>
                    </div>
                </div>
                <div class="mb-6">
                    <label for="steamid" class="block mb-2 text-sm font-medium text-gray-900">Steam ID</label>
                    <input type="text" name="steam_id" id="steamid" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="STEAM_0:1:103571697" required>
                </div>
                <div class="mb-6">
