            ...
            <form>
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    <div>
                        ...
                        <input type="text" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Callaway Corvette C7.R" required>
                    </div>
                    <div>
