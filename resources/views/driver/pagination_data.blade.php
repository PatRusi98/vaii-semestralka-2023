    ...
    @foreach($drivers as $driver)
        <div class="max-w-sm border rounded-lg shadow-md bg-gray-800 border-gray-700">
            ...
            <div class="p-5">
                ...
                <a href="{{route('driver.show', $driver->id)}}" data-bs-toggle="modal" data-bs-target="#exampleModal" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Show
